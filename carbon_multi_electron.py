...
from simulation import run_simulation, Nucleus, Electron
...
simulation = run_simulation(
    ...
    fps=24,
    electron_repulsion_strength=0.1,  # Enable electron-electron repulsion
    enable_nuclear_motion=False,      # Keep nucleus fixed
    orbital_mixing_strength=0.1,      # Enable orbital mixing for dynamics
    mixing_frequency=400              # Mix orbitals every 400 steps
)
